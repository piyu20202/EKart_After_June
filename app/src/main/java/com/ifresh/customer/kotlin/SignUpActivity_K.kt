...
class SignUpActivity_K : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        chPrivacy.setOnClickListener(View.OnClickListener { v ->
            val checked = (v as CheckBox).isChecked
            // Check which checkbox was clicked
            if (checked) {
                lytWholesaler.visibility = VISIBLE
                // Do your coding
            } else {
                lytWholesaler.visibility = GONE
                // Do your coding
            }
        })
    ...
    private fun callaSighup(activity: SignUpActivity_K, phone_no: String) {
        ...
        {
            params["is_wholesaler"] = "1"
            params["firmname"] = edtWholesaler.text.toString()
        }
        else
        {
            params["is_wholesaler"] = "0"
            params["firmname"] = ""
        }
        if(edtlastname.text.isEmpty())
            params["lname"] = ""
