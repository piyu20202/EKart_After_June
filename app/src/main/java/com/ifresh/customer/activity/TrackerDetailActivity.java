...
public class TrackerDetailActivity extends AppCompatActivity {
    ...
    TextView tvItemTotal, tvTaxPercent, tvTaxAmt, tvDeliveryCharge, tvTotal, tvPromoCode, tvPCAmount, tvWallet, tvFinalTotal,tvRevisedTotal, tvDPercent, tvDAmount;
    ...
    View l4;
    LinearLayout returnLyt, lytPromo, lytWallet, lytPriceDetail,lytReview,lytRevisedTotal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lytRevisedTotal = findViewById(R.id.lytRevisedTotal);
        ...
        tvRevisedTotal = findViewById(R.id.tvRevisedTotal);
        ...
        txtdeliverydate.setText(order.getDate_delivery());
           txtPrate.setText(order.getProduct_rate());
            txtDrate.setText(order.getDboy_rate());
        ...
        if (!order.getFinal_total().equals(order.getReceived_total()))
        {
            lytRevisedTotal.setVisibility(View.VISIBLE);
            tvRevisedTotal.setText(Constant.SETTING_CURRENCY_SYMBOL + order.getReceived_total());
        }
        else if (order.getStatus().equals("delivered") && !order.getDelivery_total().equalsIgnoreCase("0"))
        {
            lytRevisedTotal.setVisibility(View.VISIBLE);
            tvRevisedTotal.setText(Constant.SETTING_CURRENCY_SYMBOL + order.getFinal_total());
        }
