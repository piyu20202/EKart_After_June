...
public class SearchActivity_2 extends AppCompatActivity {
            ...
            public boolean onQueryTextChange(String newText) {
                if (!newText.equals("") || newText.length() != 0)
                {
                    ...
                    if (from != null && from.equalsIgnoreCase(Constant.FROMSEARCH)) {
                        if (newText.length() >= 3) {
                            //online search
                            url_receive = url_receive + query;
                            callApiProductlist(url_receive);
                            //Log.d("Url",url_receive);
                        }
                    }
                    else{
                         if (newText.length() >= 3) {
    ...
    public void callApiProductlist(String url_receive)
    {
        ...
        }, SearchActivity_2.this, url_receive, params, true);
