...
public class OfferProductListActivity extends AppCompatActivity {
    ...
    private int offset, filterIndex,position,view_tag;
    int total;
    ...
    private Menu menu;
    private LinearLayout nodata_view,lyt_view_tag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lyt_view_tag = findViewById(R.id.lyt_view_tag);

        view_all_category = findViewById(R.id.view_all_category);


        offer_id = getIntent().getStringExtra("offer_id");
        from = getIntent().getStringExtra("from");
        name = getIntent().getStringExtra("name");
        view_tag = getIntent().getIntExtra("view_tag",0);
        ...
        if (view_tag==1)
        {
            lyt_view_tag.setVisibility(View.VISIBLE);
            view_all_category.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(OfferProductListActivity.this, ProductCategory.class));
                }
            });
        }
