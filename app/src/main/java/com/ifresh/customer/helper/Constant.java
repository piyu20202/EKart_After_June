...
public class Constant {
    ...
    /*========================================================================================================*/
    //online path
    //public static String BASEPATH = "http://65.0.127.124:3000/api/";
    //public static String IMAGEBASEPATH= "http://65.0.127.124:3000/uploads/";

    /*=========================================================================================================*/
    //Staging server path
    public static String BASEPATH = "https://ifresh.adiyogitechnology.com/api/";
    public static String IMAGEBASEPATH = "https://ifresh.adiyogitechnology.com/uploads/";
    ...
    //paytm web constant
    public static String PAYTM_WEBSITE_NAME="default";
    public static String PAYTM_HOST = "";

    //tag for view all
    public static Integer VIEW_TAG = 0;
    ...
    public static String merchant_id = "paytm_mid";
    public static String merchant_key = "paytm_mkey";
