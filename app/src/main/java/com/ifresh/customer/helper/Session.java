...
public class Session {
    ...
    public static final String KEY_is_wholesaler= "is_wholesaler";
    public static final String KEY_wholesaler_firmname="";
    ...
    public void createUserLoginSession_new(String id, String fname, String lname,
        ...
        editor.putBoolean(KEY_is_wholesaler, is_wholesaler);
        editor.putString(KEY_wholesaler_firmname, wholesaler_firmname);
    ...
    public boolean isUserWholesaler()
    {
        return pref.getBoolean(KEY_is_wholesaler, false);
    }
